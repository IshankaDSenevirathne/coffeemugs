  ...
  return (
    <div className="flex flex-col">
      <div className="mt-48 pb-20">
        <h1 className="text-6xl font-bold text-white text-left pl-44">Start brewing your favourite coffee,</h1>
      </div>
      <div className=" mb-10 flex items-center justify-center text-[#7A3636]">
          <div className="grid grid-cols-3 gap-1 px-16">
              <div className="flex flex-col gap-1">
                <div href="" className="group bg-white delay-10 duration-300  flex flex-col hover:bg-red-300 hover:text-black">
                  ...
                  <a href="#" className=" text-2xl font-bold text-center py-2"> ESPRESSO </a>
                </div>
              </div>
              <div className="flex flex-col gap-1">
                <div href="" className="group bg-white delay-10 duration-300  flex flex-col hover:bg-red-300 hover:text-black">
                  ...
                  <a href="#" className="text-2xl font-bold text-center py-2"> CAPPUCHINO </a>
                </div> 
              </div>
              <div className="flex flex-col gap-1">
                <div href="" className="group bg-white delay-10 duration-300  flex flex-col hover:bg-red-300 hover:text-black">
                  ...
                  <a href="#" className="text-2xl font-bold text-center py-2"> MACHO </a>
                </div> 
              </div>
          </div>    
      </div>
