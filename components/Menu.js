              ...
              <div className="flex flex-col gap-1">
                <div href="" className="group bg-white delay-10 duration-300  flex flex-col hover:bg-red-300 hover:text-black">
                  <div className="relative">
                    ...
                    <a href="#" className="xl:opacity-0 xl:group-hover:opacity-100 delay-10 duration-300 absolute bottom-0 right-0 text-2xl xl:text-4xl mb-2 font-bold mr-2 text-center text-white"> 5.99<span className="text-[#7A3636]">$</span> </a>
                  </div>
              ...
              <div className="flex flex-col gap-1">
                <div href="" className="group bg-white delay-10 duration-300  flex flex-col hover:bg-red-300 hover:text-black">
                  <div className="relative">
                    ...
                    <a href="#" className="xl:opacity-0 xl:group-hover:opacity-100 delay-10 duration-300 absolute bottom-0 right-0 text-2xl xl:text-4xl mb-2 font-bold mr-2 text-center text-white"> 11.99<span className="text-[#7A3636]">$</span> </a>
                  </div>
              ...
              <div className="flex flex-col gap-1">
                <div href="" className="group bg-white delay-10 duration-300  flex flex-col hover:bg-red-300 hover:text-black">
                  <div className="relative">
                    ...
                    <a href="#" className="xl:opacity-0 xl:group-hover:opacity-100 delay-10 duration-300 absolute bottom-0 right-0 text-2xl xl:text-4xl mb-2 font-bold mr-2 text-center text-white"> 8.99<span className="text-[#7A3636]">$</span></a>
                  </div>
