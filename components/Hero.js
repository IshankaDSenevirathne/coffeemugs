    ...
    <div>
        <div className="container mx-auto px-20">
            ...
            <div>
                ...
                <div className="mb-2">
                    <button className="mt-5 px-5 py-4 rounded-md text-lg font-bold text-[#7A3636] bg-white hover:bg-red-300 hover:text-black active:bg-grey-900 focus:outline-none transition-all w-56">
                        Start Brewing
                    </button>
                </div>
            </div>
