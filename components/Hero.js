  ...
  return (
    <div className="">
        <div className="container mx-auto px-5 lg:px-20">
            <div className="grid py-10 md:grid md:grid-cols-6 justify-center items-center min-h-screen">
                <div className="md:col-span-3">
                    <h1 className=" flex text-4xl md:text-5xl xl:text-6xl font-bold text-black text-left max-w-2xl mb-10">
                        ENJOY WORLD’S FINEST COFFEE !
                    </h1>
                    <h5 className="flex text-md text-xl xl:text-2xl font-bold text-[#C1C1C1] text-left">
